...
# endregion
        ...
        public static readonly System.Text.StringBuilder response = new System.Text.StringBuilder();
        ...
        public static void ExceptionCaught(System.Exception Exception)
        {
            throw (Exception);
        }

        public string WaitFor(string Prompt)
        {
            string read = "";
            while (true)
            {
                if (Prompt != "")
                {
                    if (response.ToString().IndexOf(Prompt) > -1)
                    {
                        break;
                    }
                ...
                {
                    if (response.ToString().IndexOf("#") > -1) break;
                    if (response.ToString().IndexOf("$") > -1) break;
                    if (response.ToString().IndexOf(">") > -1) break;
                }
                System.Threading.Thread.Sleep(100);
